...
Timeline._Band.prototype.getViewWidth = function() {
    if (this._timeline.isHorizontal()) {
        return this._div.cachedOffsetHeight ? this._div.cachedOffsetHeight : (this._div.cachedOffsetHeight = this._div.offsetHeight);
    } else {
        return this._div.cachedOffsetWidth  ? this._div.cachedOffsetWidth  : (this._div.cachedOffsetWidth = this._div.offsetWidth);
    }
};
